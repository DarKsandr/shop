                    ...
                    <div class="blog-posts">
                        <div class="single-blog-post blog-grid-post">
                            ...
                            <div class="blog-post-content-inner mt-30px">
                                ...
                                <h4 class="blog-title">10 Principles of Psychology You Can Use to Improve Your Smart Product
                                </h4>
                                <p data-aos="fade-up">
                        ...
                        <div class="another-post">
                            <div class="content-side">
                                <p class="mb-30px">Lorem ipsum dolor sit amet, consec adipisic elit, sed do eius tempor
                                    incididu ut labore et dolore ma aliqua Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nil ut aliquip ex ea commodo consequat. Duis aute irure
                                    dolor in reprehenderit in voluptat velit esse cillum dolore</p>
                                <p>leu fugiat nulla pariatur. Excepteur sintocca
                                    cupidatat non proident, sunt in culpa qui off deserunt mollit anim id est laborum. Sed
                                    utl perspiciatis unde omnis iste natus error sit voluptatem accusantium</p>
                            </div>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore eto dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamcol
                            laboris nisi ut aliquipp ex ea commodo consequat. Duis aute irure dolor in reprehenderit inloifk
                    ...
                    <div class="blog-nav">
                        <div class="blog-nav-wrap">
                            <div class="nav-left d-flex justify-content-start align-items-center">
                                <a class="nav-img" href="{{route('blog-single', 1)}}"><img
                                ...
                                <div class="review-content">
                                    ...
                                    <div class="review-bottom">
                                        <p>
                                            ...
                                            labore et dol magna aliqua. Ut enim ad minim veniam.
                                        </p>
                                        <div class="review-left">
                                            <a href="#">Reply</a>
                                        </div>
